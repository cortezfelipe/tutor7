...
class DatagridCheckView extends TPage
{
    ...
    public function __construct()
    {
        ...
        $check->type = 'checkbox';
        $check->title = 'Marcar/Desmarcar';
        $check->onclick = "$('input:checkbox').not(this).prop('checked',this.checked);";


        // add the columns
        $this->datagrid->addColumn( new TDataGridColumn('check',   $check,   'center',  '70') );
